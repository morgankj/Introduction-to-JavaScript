...
function annoyingSong(startingNum){
  for (let i=0; i < startingNum; i++){
    return(`${startingNum - i} bottles of soda on the wall, ${startingNum - i} bottles of soda, take one down pass it around ${(startingNum - i) - 1} bottles of soda on the wall`);
  }
}
